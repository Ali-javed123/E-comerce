...
export default function ProductDetailGroupLayout() {
...
<Carousel infiniteLoop useKeyboardArrows autoPlay>
            ...
            <div className="col-lg-6">
              <div className="product-details-des mt-md-34 mt-sm-34">
               ...
               <table className="table table-bordered group-product-table mt-10 mb-20">
  <tbody>
    <tr className="text-center">
      <td>
      <div className='pro-qty'>

<span onClick={decNum} className="dec qtybtn">-</span><input type="text"  readOnly value={num} onChange={handleChange} /><span onClick={incNum} className="inc qtybtn">+</span>
</div>
      </td>
...
<span onClick={decNum2} className="dec qtybtn">-</span><input type="text"  readOnly value={num2} onChange={handleChange2} /><span onClick={incNum2} className="inc qtybtn">+</span>
</div>
      </td>
