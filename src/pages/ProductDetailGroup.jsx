...
import ProductDetailBreadcrum from '../component/ProductDetailGroup/ProductDetailGroupBreadcrum'
import ProductDetailLayout from '../component/ProductDetailGroup/ProductDetailGroupLayout'
import Home2Section6 from '../component/Home2/Home2Section6'
import Footer from '../component/globleComponent/Footer'

export default function ProductDetailGroup() {
  return (
    <>
