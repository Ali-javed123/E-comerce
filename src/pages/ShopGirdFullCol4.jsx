...
import ShopGirdFull4ColBreadcrum from '../component/ShopGirdFull4Col/ShopGirdFull4ColBreadcrum'
import ShopGirdFull4ColSection from '../component/ShopGirdFull4Col/ShopGirdFull4ColSection'
import Footer from '../component/globleComponent/Footer'
import Home2Section6 from '../component/Home2/Home2Section6'
export default function ShopGirdFullCol4() {
  return (
    <>
