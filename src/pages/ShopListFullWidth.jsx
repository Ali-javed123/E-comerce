...
import ShopListFullWidthBreadcrum from '../component/ShopListFullWidht/ShopListFullWidthBreadcrum'
import ShopFullWidthSection from '../component/ShopListFullWidht/ShopFullWidthSection'
import Footer from '../component/globleComponent/Footer'
import Home2Section6 from '../component/Home1/Home1Section6'
export default function ShopListFullWidth() {
  return (
    <>
{/*`
